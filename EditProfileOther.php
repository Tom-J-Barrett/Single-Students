...
<div class="wrapper">
    ...
    <div id="navbar">
        <ul>
            ...
            <li><a href = "AddAdmin.php" />Admin <span class = "glyphicon glyphicon-heart-empty"></span></a></li>
...
<!-- Reference: https://donpnz.files.wordpress.com/2013/03/couple_crop-0023.jpg -->
    <div class="container">
        <div class="signuptext container">
            ...
            <form action="EditProfileOtherUpdate.php" method="POST">
                <div class="row">
                    <div class="col-md-3">
                        Forename
                    </div>
